...
namespace custom
{
    ...
    std::pair<typename BST <T> ::iterator, bool> BST <T> ::insert(const T& t, bool keepUnique)
    {
        if (root == nullptr)
        {
            ...
            root = pNew;
            std::pair<iterator, bool> pairReturn(begin(), true);
            return pairReturn;
        }
        ...
        while (notDone)
        {
            if (t < p->data)
            {
                ...
                else
                {
                    ...
                    notDone = false;
                    numElements++;
                    std::pair<iterator, bool> pairReturn(iterator(p->pLeft), true);
                    return pairReturn;
                }
            }
            ...
            else if (!keepUnique)
            {
                while (notDone)
                {
                    ...
                    else
                    {
                        ...
                        notDone = false;
                        numElements++;
                        std::pair<iterator, bool> pairReturn(iterator(p->pRight), true);
                        return pairReturn;
                    }
                }
            }
            else
            {
                while (notDone)
                {
                    ...
                    {
                        notDone = false;
                        std::pair<iterator, bool> pairReturn(iterator(p), false);
                        return pairReturn;
                    }
                    else if (p->pRight)
                        p = p->pRight;
